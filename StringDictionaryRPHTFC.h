...
class StringDictionaryRPHTFC : public StringDictionary
{
	...
	protected:
		...
		*/
		inline uint searchPrefix(ChunkScan* c, uint scanneable, uchar *str, uint strLen, uint_fast32_t *offset);
		...
		/** Searches the first string non-prefixed for the given one.
		    ...
		    @returns the internal ID (of 0 if it is not in the bucket).
		*/
		inline uint_fast32_t searchDistinctPrefix(ChunkScan* c, uint_fast32_t scanneable, uchar *str, uint_fast32_t strLen, uint_fast32_t *offset);
		...
		*/
		inline uint_fast32_t encodeSymbol(uint_fast32_t symbol, uchar *text, uint_fast32_t *offset);
		...
		/** Decodes the next symbol.
		    ...
		    @returns the number of advanced bytes in this operation.
		*/
		inline uint_fast32_t decodeSymbol(uint_fast32_t *symbol, uchar *ptr, uint_fast32_t *offset);
		 ...
		 */
		inline uint decodeString(uchar *str, uint_fast32_t *strLen, uchar **ptr, uint_fast32_t *offset);
}; 
