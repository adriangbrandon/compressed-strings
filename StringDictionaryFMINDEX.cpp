...
uchar*
StringDictionaryFMINDEX::extract(uint64_t id, uint_fast32_t *strLen)
{
	if ((id > 0) && (id <= elements))
	{
		size_t i;
...
IteratorDictString*
StringDictionaryFMINDEX::extractSubstr(uchar *str, uint_fast32_t strLen)
{
	if(BWTsampling == 0)
	{
...
uchar*
StringDictionaryFMINDEX::extractRank(uint64_t rank, uint_fast32_t *strLen)
{
