...
StringDictionaryRPHTFC::StringDictionaryRPHTFC(IteratorDictString *it, uint32_t bucketsize)
{
	this->type = RPHTFC;
	...
	uint64_t bucket = 1; uint64_t buckets = dict->buckets;
	uint64_t ptrpdict = 0;
	...
	// 3) Compressing the dictionary and building the decoding table
	{
		...
		size_t ptrB = 0, ptrE = 0; uint_fast32_t offset = 0, bytes = 0;
...
uint64_t
StringDictionaryRPHTFC::locate(uchar *str, uint_fast32_t strLen)
{
...
uchar *
StringDictionaryRPHTFC::extract(uint64_t id, uint_fast32_t *strLen)
{
	if ((id > 0) && (id <= elements))
	{
...
IteratorDictString*
StringDictionaryRPHTFC::extractSubstr(uchar *str, uint_fast32_t strLen)
{
...
uchar *
StringDictionaryRPHTFC::extractRank(uint64_t rank, uint_fast32_t *strLen)
{
...
uint 
StringDictionaryRPHTFC::searchPrefix(ChunkScan* c, uint scanneable, uchar *str, uint strLen, uint_fast32_t *offset)
{
	uint id = NORESULT;
...
uint_fast32_t
StringDictionaryRPHTFC::searchDistinctPrefix(ChunkScan* c, uint_fast32_t scanneable, uchar *str, uint_fast32_t strLen, uint_fast32_t *offset)
{
	uint_fast32_t id = 1;
...
uint_fast32_t
StringDictionaryRPHTFC::encodeSymbol(uint_fast32_t symbol, uchar *text, uint_fast32_t *offset)
{
	uint processed = 0;
	uint bytes = 0;
...
StringDictionaryRPHTFC::decodeSymbol(uint_fast32_t *symbol, uchar *ptr, uint_fast32_t *offset)
{
	*symbol = 0;
...
inline uint
StringDictionaryRPHTFC::decodeString(uchar *str, uint_fast32_t *strLen, uchar **ptr, uint_fast32_t *offset)
{
