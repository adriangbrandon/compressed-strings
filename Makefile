...
FLAGS= -Wall -g -DNDEBUG -fsanitize=integer -fsanitize=undefined -fsanitize=address -I libcds/includes/ # Debug
...
OBJECTS=$(OBJECTS_UTILS) $(OBJECTS_HUTUCKER) $(OBJECTS_HUFFMAN) $(OBJECTS_REPAIR) $(OBJECTS_HASH) $(OBJECTS_XBW) $(OBJECTS_FMINDEX) StringDictionary.o StringDictionaryPFC.o StringDictionaryHHTFC.o StringDictionaryRPHTFC.o
EXES=Build.o Test.o
