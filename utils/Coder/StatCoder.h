...
class StatCoder
{
	public:
		...
		*/
		uint_fast32_t encodeSymbol(uchar symbol, uchar *text, uint_fast32_t *offset);
		...
		*/
		uchar* encodeString(uchar *str, uint_fast32_t strLen, uint_fast32_t *encLen, uint_fast32_t *offset);
