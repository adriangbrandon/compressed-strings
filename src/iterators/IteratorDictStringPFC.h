...
class IteratorDictStringPFC : public IteratorDictString {
    ...
    */
    IteratorDictStringPFC(uchar* ptrS, uint offset, uint bucketsize,
    ...
    */
    ...
    /** Generic destructor. */
    ~IteratorDictStringPFC() { delete[] strCurr; }

   protected:
    uchar* ptrS;  //! Pointer to the sequence of internal strings

    uint_fast32_t pos;         //! Internal position in the bucket
    uint_fast32_t bucketsize;  //! Size of the current bucket

    uchar* strCurr;         //! Current string
    uint_fast32_t lenCurr;  //! Length of 'strCurr'

    uint_fast32_t
        lenPrefix;  //! Auxiliar storing the length of the common prefix
    uint_fast32_t
        lenSuffix;  //! Auxiliar storing the length of the remaining suffix
