...
class StringDictionary 
{
	public:		
		...
		*/
		virtual uint64_t locate(uchar *str, uint_fast32_t strLen)=0;
		...
		/** Obtains the string associated with the given ID.
		    ...
		    @returns the requested string (or NULL if it is not in the
		      dictionary).
		*/
		virtual uchar* extract(uint64_t id, uint_fast32_t *strLen)=0;
		...
		*/
		...
		/** Extracts all elements containing by the given substring.
		    ...
		    @returns an iterator for direct scanning of all the strings.
		*/
		virtual IteratorDictString* extractSubstr(uchar *str, uint_fast32_t strLen)=0;
		...
		/** Obtains the string  with rank k according to its 
		    ...
		    @returns the requested string (or NULL if it is not in the
		      dictionary).
		*/
		virtual uchar* extractRank(uint64_t rank, uint_fast32_t *strLen)=0;
