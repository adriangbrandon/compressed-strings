...
class StringDictionaryPFC : public StringDictionary {
    ...
    */
    StringDictionaryPFC(IteratorDictString *it, uint_fast32_t bucketsize);
    ...
    */
    uint64_t locate(uchar *str, uint_fast32_t strLen);
    ...
    */
    static unique_ptr<StringDictionary> load(ifstream &in);
   ...
   protected:
    ...
    shared_ptr<LogSequence>
        blStrings;  //! Positional index to the strings representation
    ...
    */
    inline void decodeNextString(uchar **ptr, uint lenPrefix, uchar *str,
                                 uint *strLen);
    ...
    */
    inline void locateBoundaryBuckets(uchar *str, uint strLen, size_t *left,
                                      size_t *right);
    ...
    */
    inline uint searchPrefix(uchar **ptr, uint scanneable, uchar *decoded,
                             uint *decLen, uchar *str, uint strLen);
    ...
    /** Searches the first string non-prefixed for the given one.
        ...
        @returns the internal ID (of 0 if it is not in the bucket).
    */
    inline uint searchDistinctPrefix(uchar *ptr, uint scanneable,
