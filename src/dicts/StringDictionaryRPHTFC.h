...
class StringDictionaryRPHTFC : public StringDictionary {
    ...
    */
    StringDictionaryRPHTFC(IteratorDictString *it, uint32_t bucketsize);
    ...
    */
    uint64_t locate(uchar *str, uint_fast32_t str_length);
    ...
    /** Obtains the string associated with the given ID.
        ...
        @returns the requested string (or NULL if it is not in the
          dictionary).
     */
    uchar *extract(uint64_t id, uint_fast32_t *strLen);
   ...
   protected:
    ...
    uint64_t buckets;     //! Number of total buckets in the dictionary
    uint32_t bucketsize;  //! Number of strings per bucket

    uint64_t bytesStrings;  //! Length of the strings representation
    uchar *textStrings;  //! Hu-Tucker over the Front-Coding representation of
    ...
    */
    inline void locateBoundaryBuckets(uchar *str, uint strLen, uint offset,
    ...
    */
    inline uint searchPrefix(ChunkScan *c, uint scanneable, uchar *str,
                             uint strLen, uint_fast32_t *offset);
    ...
    /** Searches the first string non-prefixed for the given one.
        ...
        @returns the internal ID (of 0 if it is not in the bucket).
    */
    inline uint_fast32_t searchDistinctPrefix(ChunkScan *c,
                                              uint_fast32_t scanneable,
    ...
    */
    inline uint_fast32_t encodeSymbol(uint_fast32_t symbol, uchar *text,
                                      uint_fast32_t *offset);
    ...
    /** Decodes the next symbol.
        ...
        @returns the number of advanced bytes in this operation.
    */
    inline uint_fast32_t decodeSymbol(uint_fast32_t *symbol, uchar *ptr,
                                      uint_fast32_t *offset);
     ...
     */
    inline uint decodeString(uchar *str, uint_fast32_t *strLen, uchar **ptr,
                             uint_fast32_t *offset);
};
