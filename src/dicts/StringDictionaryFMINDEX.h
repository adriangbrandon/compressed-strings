...
class StringDictionaryFMINDEX : public StringDictionary {
   public:
     ...
     */
    StringDictionaryFMINDEX(IteratorDictString *it, bool sparse_bitsequence,
                            int bparam, size_t bwt_sample);
     ...
     */
    uint64_t locate(uchar *str, uint_fast32_t strLen) override;
    ...
    @param strLen: pointer to the extracted string length.
     ...
     dictionary).
     */
    uchar *extract(uint64_t id, uint_fast32_t *strLen) override;
    ...
    @returns an iterator for direct scanning of all the strings.
     */
    IteratorDictString *extractSubstr(uchar *str,
                                      uint_fast32_t strLen) override;
    ...
    */
    static std::unique_ptr<StringDictionary> load(ifstream &in);
   ...
   protected:
    ...
    void build_ssa(uchar *text, size_t len, bool sparse_bitsequence,
                   int bparam);
};
