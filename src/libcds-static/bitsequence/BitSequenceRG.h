...
/** Implementation of Rodrigo Gonzalez et al. practical rank/select solution
 * [1]. The interface was adapted.
 *
...
class BitSequenceRG : public BitSequence {
   ...
   public:
     ...
     * The <code>factor</code> value has to be either 2,3,4 or 20, being the
     * first one the fastest/bigger.
     */
