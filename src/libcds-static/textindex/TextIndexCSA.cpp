...
TextIndexCSA::TextIndexCSA() { csa = NULL; }
...
size_t TextIndexCSA::locate(uchar *pattern, ulong length, ulong **occ,
                            ulong *numocc) const {
    return (size_t)cds_static::locate(csa, pattern, length, occ, numocc);
}

size_t TextIndexCSA::extract(ulong from, ulong to, uchar **snippet,
                             ulong *snippet_length) const {
    return (size_t)cds_static::extract(csa, from, to, snippet, snippet_length);
}

size_t TextIndexCSA::display(uchar *pattern, ulong length, ulong numc,
                             ulong *numocc, uchar **snippet_text,
                             ulong **snippet_lengths) const {
    return (size_t)cds_static::display(csa, pattern, length, numc, numocc,
                                       snippet_text, snippet_lengths);
}

size_t TextIndexCSA::index_length() const { return (size_t)(csa->n); }
