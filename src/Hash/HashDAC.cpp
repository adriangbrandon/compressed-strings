...
size_t HashDAC::insert(uchar *w, size_t len, size_t offset) {
...
void HashDAC::setData(DAC_BVLS *data) { this->data = data; }

size_t HashDAC::search(uchar *w, size_t len) {
